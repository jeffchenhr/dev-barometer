...
#define RADIO_CONTROL_NB_CHANNEL 12		//we may want to change this for our uses...  it is possible it could slow us down...
#endif
...
extern void RadioControlEventImp(void); //void (*frame_handler)(void)
